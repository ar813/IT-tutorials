...
// iii. Bigint is written by the "n" suffix to end of the number (Like, 338n)
...
// Is above work in typscript that is best but on the other hand, here is another way which is basically depend on type casting. It will inshallah definitely work:
...
// No 2.
let bigNumber2 = BigInt("90071992547409925")
